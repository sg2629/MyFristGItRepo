...
library(broom)
library(grid)
data <- read.csv('/Users/shayne/Desktop/bank-additional-full.csv', header = TRUE, sep = ';')
...
## Model Diagnostic and Model Evaluation
...
bank_additional_full = read.csv('/Users/shayne/Desktop/bank-additional-full.csv',header = TRUE,sep = ";")
